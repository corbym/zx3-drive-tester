...
#define set_track_loop_last(card_ptr, text_value)                                \
    track_loop_card_set_last((card_ptr), (text_value))
#define set_track_loop_info(card_ptr, text_value)                                \
    track_loop_card_set_info((card_ptr), (text_value))
...
#define set_rpm_loop_last(card_ptr, text_value)                                  \
    rpm_loop_card_set_last((card_ptr), (text_value))
#define set_rpm_loop_info(card_ptr, text_value)                                  \
    rpm_loop_card_set_info((card_ptr), (text_value))
...
#define set_id_waiting(card_ptr)                                                 \
    read_id_probe_card_set_id_text((card_ptr), "ID    : WAITING")
#define set_id_probing(card_ptr)                                                 \
    read_id_probe_card_set_id_text((card_ptr), "ID    : PROBING")
...
#define set_precheck_ok(card_ptr)                                                \
    read_id_probe_card_set_id_text((card_ptr), "ID    : PRECHECK OK")
#define set_precheck_fail(card_ptr)                                              \
    read_id_probe_card_set_id_text((card_ptr), "ID    : PRECHECK FAIL")
...
#define set_detail_check_media(card_ptr)                                         \
    recal_seek_card_set_detail_text((card_ptr), "DETAIL: CHECK MEDIA")
...
#define set_last_no_seek(card_ptr)                                               \
    interactive_seek_card_set_last_text((card_ptr), "LAST  : NO SEEK")
#define set_last_seek_cmd_fail(card_ptr)                                         \
    interactive_seek_card_set_last_text((card_ptr), "LAST  : SEEK CMD FAIL")
#define set_last_wait_timeout(card_ptr)                                          \
    interactive_seek_card_set_last_text((card_ptr), "LAST  : WAIT TIMEOUT")
...
#define set_chrn_invalid(card_ptr)                                               \
    read_id_card_set_chrn_text((card_ptr), "CHRN  : INVALID")
#define set_detail_id_ok(card_ptr)                                               \
    read_id_card_set_detail_text((card_ptr), "DETAIL: ID READ OK")
